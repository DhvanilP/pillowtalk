...
PT_API pt_response_t *pt_put_cookie(const char *server_target, pt_node_t *document, const char *cookie);
...
PT_API pt_response_t *pt_get_cookie(const char *server_target, const char *cookie);
...
PT_API long long pt_integer_get(pt_node_t *integer);
...
PT_API pt_node_t *pt_integer_new(long long integer);
